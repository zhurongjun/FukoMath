...
// += -= *= /= %=
template<typename base_type, typename target_type, uint32_t... sequence> FORCEINLINE target_type operator += (Swizzle<true, base_type, target_type, sequence...>& lsh, const target_type& rsh) { return lsh = lsh + rsh; }
template<typename base_type, typename target_type, uint32_t... sequence> FORCEINLINE target_type operator -= (Swizzle<true, base_type, target_type, sequence...>& lsh, const target_type& rsh) { return lsh = lsh - rsh; }
template<typename base_type, typename target_type, uint32_t... sequence> FORCEINLINE target_type operator *= (Swizzle<true, base_type, target_type, sequence...>& lsh, const target_type& rsh) { return lsh = lsh * rsh; }
template<typename base_type, typename target_type, uint32_t... sequence> FORCEINLINE target_type operator /= (Swizzle<true, base_type, target_type, sequence...>& lsh, const target_type& rsh) { return lsh = lsh / rsh; }
template<typename base_type, typename target_type, uint32_t... sequence> FORCEINLINE target_type operator %= (Swizzle<true, base_type, target_type, sequence...>& lsh, const target_type& rsh) { return lsh = lsh % rsh; }
template<typename rhs_type, typename base_type, typename target_type, uint32_t... sequence> FORCEINLINE target_type operator += (Swizzle<true, base_type, target_type, sequence...>& lsh, const rhs_type& rsh) { return lsh = lsh + (base_type)rsh; }
template<typename rhs_type, typename base_type, typename target_type, uint32_t... sequence> FORCEINLINE target_type operator -= (Swizzle<true, base_type, target_type, sequence...>& lsh, const rhs_type& rsh) { return lsh = lsh - (base_type)rsh; }
template<typename rhs_type, typename base_type, typename target_type, uint32_t... sequence> FORCEINLINE target_type operator *= (Swizzle<true, base_type, target_type, sequence...>& lsh, const rhs_type& rsh) { return lsh = lsh * (base_type)rsh; }
template<typename rhs_type, typename base_type, typename target_type, uint32_t... sequence> FORCEINLINE target_type operator /= (Swizzle<true, base_type, target_type, sequence...>& lsh, const rhs_type& rsh) { return lsh = lsh / (base_type)rsh; }
template<typename rhs_type, typename base_type, typename target_type, uint32_t... sequence> FORCEINLINE target_type operator %= (Swizzle<true, base_type, target_type, sequence...>& lsh, const rhs_type& rsh) { return lsh = lsh % (base_type)rsh; }
